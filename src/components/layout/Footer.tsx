...
const Footer = () => {
  return (
    <footer className="footer footer-center bg-white border shadow-xl text-black rounded p-10">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a href="https://x.com" target="_blank" className="text-[#1DA1F2]">
            <svg
      ...
      <aside>
        ...
        <div className="mx-auto">
          <img src={keyWorld} alt="" className="w-24 bg-black" />
        </div>
      </aside>
    </footer>
  );
